...
namespace Renate\Oauth2Connector\Policies;

use Renate\Oauth2Connector\Models\Traits\ChecksScopes;
use Renate\Oauth2Connector\Contracts\Repository;
...
abstract class RepositoryModelPolicy implements RepositoryModelPolicyInterface
{
	 ...
	 *
	 * @param array                               $filters
	 * @param \Renate\Oauth2Connector\Contracts\Repository $repository
	 * @return void
	 */
